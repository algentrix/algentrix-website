...
import type { PrivacySectionContent } from '../../data/privacyPolicyContent'

type PrivacySectionProps = {
  section: PrivacySectionContent
}

export function PrivacySection({ section }: PrivacySectionProps) {
  return (
    <motion.article
      id={section.id}
      aria-labelledby={`${section.id}-heading`}
      className="privacy-section scroll-mt-4 lg:scroll-mt-6 pb-10 mb-10 border-b border-ag-gold/10 last:mb-0 last:pb-0 last:border-b-0"

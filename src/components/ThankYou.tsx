  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-8 py-24 relative overflow-hidden">
      ...
      <div className="max-w-[600px] mx-auto text-center relative">
        <h1 className="text-[2.5rem] sm:text-[3rem] font-bold mb-6">Thank You</h1>
        <p className="text-[#a0a0b0] text-[1.1rem] leading-relaxed mb-10">
        ...
        <Link
          to="/"
          className="inline-block py-4 px-8 bg-accent-orange text-bg-dark font-bold rounded-[10px] text-base transition-all hover:-translate-y-0.5 hover:shadow-glow-orange"
        >
          Back to Home
        </Link>
      </div>
